...
describe("QuestionView", () => {
  ...
  it("shows a category prompt when no entry is selected", () => {
    ...
    expect(
      screen.getByText("Choose a category to open a question."),
    ).toBeInTheDocument();
  });
  ...
  it("renders deck-specific category labels and prompts in question state", () => {
    ...
    expect(
      screen.getByText("Definitions and core distinctions"),
    ).toBeInTheDocument();
  });
  ...
  it("renders question inside a modal dialog immediately after category selection", () => {
    ...
    expect(
      screen.getByRole("button", { name: "Back to card" }),
    ).toBeInTheDocument();
  });
  ...
  it("shows context and linked source after answer reveal", () => {
    ...
    expect(
      screen.getByText(/Some modern measurements argue the Amazon is longer/i),
    ).toBeInTheDocument();
  ...
  it("renders source label without a link when no url is provided", () => {
    ...
    expect(
      screen.queryByRole("link", { name: "Game-night reference card" }),
  ...
  it("renders an answer-only modal state when revealed", () => {
    ...
    expect(
      screen.getByRole("button", { name: "Ask ChatGPT for more" }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("button", { name: "Back to card" }),
    ).toBeInTheDocument();
    expect(
      screen.queryByText("What is the longest river in the world?"),
    ).not.toBeInTheDocument();
  });
  ...
  it("calls onCloseQuestion when Back to card is pressed", () => {
  ...
  it("calls onCloseQuestion when Back to card is pressed after reveal", () => {
    const onCloseQuestion = vi.fn();
